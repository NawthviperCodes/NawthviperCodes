...
![MetaTrader5](https://img.shields.io/badge/-MT5-333333?style=flat\&logo=tradingview)
...
| --------------------------- | ----------------------------------------------------------------------- | -------------------------------------------------------------------- |
| **AI VIX75 Scalper**        | Automated trading bot for Deriv VIX75 using price action & zone logic   | [GitHub](https://github.com/NawthviperCodes/ai-vix75-scalper)        |
| **Telegram Signal Bot**     | Automates sending forex trading signals via Telegram                    | [GitHub](https://github.com/NawthviperCodes/telegram-signal-bot)     |
| **Flask Trading Dashboard** | Web dashboard to control MT5 bots from the browser                      | [GitHub](https://github.com/NawthviperCodes/flask-trading-dashboard) |
| **EduBridge Platform**      | Web app for cross-university module registration (FastAPI + PostgreSQL) | [GitHub](https://github.com/NawthviperCodes)                         |
